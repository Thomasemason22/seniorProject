...
def seed_database(record_count=1000):
    with app.app_context():
        ...
        for _ in range(record_count):
            ...
            scanned_volume = randint(*profile["scan_range"]) if "scan_range" in profile else int(
                gross_volume * uniform(*profile["scan_rate"])
            )
            ...
            actual_pph = round(scanned_volume / paid_day, 2) if paid_day else 0
